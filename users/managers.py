...
class UserManager(BaseUserManager):
    ...
    def _create_user(self, email, full_name, cpf,  password, **extra_fields):
        if not email:
            raise ValueError('Um email precisa ser fornecido')
        elif not full_name:
            raise ValueError('Um nome precisa ser fornecido')
        elif not cpf:
            raise ValueError('Um CPF precisa ser fornecido')
    ...
    def create_user(self, email=None, full_name=None, cpf=None, password=None, **extra_fields):
        extra_fields.setdefault('is_staff', False)
        extra_fields.setdefault('is_superuser', False)
        return self._create_user(email, full_name, password, **extra_fields)

    def create_superuser(self, email, full_name, cpf, password, **extra_fields):
        ...
        return self._create_user(email, full_name, cpf, password, **extra_fields)
